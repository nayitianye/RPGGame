...
namespace FightSystem
{
    ...
    {
        //系统各种属性的预定义
        public static void define(Player[] players,Npc[] npcs,Map[] maps)
        {
            //player define
            ...
            players[0].fset("主角1", "fight/p1.png", -120, -120,
                "fight/fm_face1.png",
                anm_att, anm_item, anm_skill);

            players[1].fset("主角2", "fight/p2.png", -120, -120,
                "fight/fm_face2.png",
                anm_att, anm_item, anm_skill);

            players[2].fset("主角3", "fight/p3.png", -120, -120,
                "fight/fm_face3.png",
                anm_att, anm_item, anm_skill);
